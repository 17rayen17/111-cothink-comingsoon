  ...
  const handelForm = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if(emailPattern.test(mail)){
      ...
      await sendMail({
        ...
        <div style="max-width: 125px;"><img src="http://localhost:3000/assets/logo.svg" style="display: block; height: auto; border: 0; width: 100%;" width="125"/></div>
        </div>
        </td>
        </tr>
        </table>
        ...
        <tr>
        <td style="padding:0 2px 0 2px;"><a href="https://www.facebook.com/111CoThinkers/" target="_blank"><img alt="Facebook" height="32" src="http://localhost:3000/assets/facebook2x.png" style="display: block; height: auto; border: 0;" title="facebook" width="32"/></a></td>
        <td style="padding:0 2px 0 2px;"><a href="https://www.linkedin.com/company/cothink-111?originalSubdomain=tn" target="_blank"><img alt="Linkedin" height="32" src="http://localhost:3000/assets/linkedin2x.png" style="display: block; height: auto; border: 0;" title="linkedin" width="32"/></a></td>
        <td style="padding:0 2px 0 2px;"><a href="https://www.instagram.com/111cothink/" target="_blank"><img alt="Instagram" height="32" src="http://localhost:3000/assets/instagram2x.png" style="display: block; height: auto; border: 0;" title="instagram" width="32"/></a></td>
        </tr>
        </table>
        </div>
        </td>
